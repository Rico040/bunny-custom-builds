...
(() => {
  ...
  var constants, channels, i18n, url, clipboard, assets, invites, commands, navigation, toasts, messageUtil, navigationStack, NavigationNative, tokens, Users, Profiles, AsyncUsers, Flux, FluxDispatcher, React2, ReactNative, moment, chroma, lodash, Skia, util;
  var init_common = __esm({
    "src/metro/common/index.ts"() {
      ...
      Users = findByPropsProxy("getCurrentUser");
      Profiles = findByPropsProxy("showUserProfile");
      AsyncUsers = findByPropsProxy("getUser", "fetchProfile");
...
//# sourceURL=${plugin.id}?hash=${plugin.manifest.hash}`;
  ...
  function Authors() {
    var _loop3 = function(author2) {
      children.push(/* @__PURE__ */ __bunny_createElement(Text, {
        variant: "text-md/semibold",
        color: "text-muted",
        onPress: function() {
          return handlePress(author2.id);
        }
      }, author2.name));
      children.push(", ");
    };
    ...
    var handlePress = function(authorId) {
      if (authorId) {
        if (!Users.getUser(authorId)) {
          AsyncUsers.fetchProfile(authorId).then(function() {
            Profiles.showUserProfile({
              userId: authorId
            });
          });
        } else {
  ...
  function Title() {
    ...
    }, icon && /* @__PURE__ */ __bunny_createElement(import_react_native16.Image, {
      style: [
        styles3.smallIcon,
        {
          marginRight: 4
